 ...
 * and has no Boot 4 artifact (remkop/picocli#2491 open, #2507 unmerged), so the
 * starter dependency was dropped in favor of this minimal equivalent. Looks up
 * command classes in the Spring {@link ApplicationContext} (prototype creation
 * via the autowire-capable factory) and falls back to picocli's default factory.
 */
