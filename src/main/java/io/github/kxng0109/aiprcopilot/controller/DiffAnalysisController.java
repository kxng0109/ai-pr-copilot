...
public class DiffAnalysisController {
    ...
    ResponseEntity<ErrorResponse> analyzeDiffRateLimited(
            @RequestBody AnalyzeDiffRequest request, RequestNotPermitted ex, HttpServletRequest httpRequest) {
    ...
    public ResponseEntity<java.util.Map<String, Object>> analyzeDiffSarif(
